...
from pipe.models.pipe.utils import my_import, make_zero_conv
...
class DownBlock(nn.Module):
    def __init__(
        ...
        if self.apply_zero_conv:
            self.zero_conv = make_zero_conv(channels=in_channels, conv_op=conv_op)
