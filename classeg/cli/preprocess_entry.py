...
@click.option("--no_normalize", "--no_n", help="Should we skip computing and saving the normalized data.", type=bool, is_flag=True, )
...
def main(folds: int, processes: int, no_normalize: bool, dataset_id: str, extension: str, dataset_description: str, extra_args: List[str]):
    kwargs = {}
    ...
    preprocessor = preprocessor(
        dataset_id=dataset_id, normalize=not no_normalize, folds=folds, processes=processes, dataset_desc=dataset_description, **kwargs
    )
